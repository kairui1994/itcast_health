...
public class MessageConstant {
    ...
    public static final String DELETEALL_ORDER_FAIL = "删除失败，不能删除已到诊记录";
    ...
    public static final String EDIT_USER_SUCCESS = "修改用户信息成功";
    public static final String EDIT_USER_FAIL = "修改用户信息失败";
    ...
    public static final String GET_ROLEIDS_SUCCESS = "获取角色id成功";
    public static final String GET_ROLEIDS_FAIL = "获取角色id成功";
}
